...
<div class="w-50 mx-auto bg-grey">
      <h1 class="text-center pt-5">Cliente</h1>
          <form method="post">
        ...
        if (isset($_POST['enviar'])) {
            if (strlen($_POST['nombre']) >= 1 && strlen($_POST['saldo_cuenta']) >= 1) {
                ...
                $consulta = "INSERT INTO cliente(id_cli, nombre_cli, numero_cuenta_cli, saldo_cuenta_cli) VALUES ('$id','$nombre','$numero_cuenta','$saldo_cuenta')";
